================================================================================
    MICROSOFT 基础类库: ProjWYF 项目概述
===============================================================================

应用程序向导已为您创建此 ProjWYF 应用程序。此应用程序不仅演示使用 Microsoft 基础类的基本知识，而且可作为编写应用程序的起点。

此文件包含组成 ProjWYF 应用程序的各个文件的内容摘要。
...
ProjWYF.h
    这是应用程序的主要头文件。它包括其他项目特定的头文件(包括 Resource.h)，并声明 CProjWYFApp 应用程序类。

ProjWYF.cpp
    这是包含应用程序类 CProjWYFApp 的主要应用程序源文件。

ProjWYF.rc
    这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源位于 2052 中。

res\ProjWYF.ico
    这是用作应用程序图标的图标文件。此图标包括在主要资源文件 ProjWYF.rc 中。
...
ProjWYFDlg.h，ProjWYFDlg.cpp - 对话框
    这些文件包含 CProjWYFDlg 类。该类定义应用程序主对话框的行为。该对话框的模板位于 ProjWYF.rc 中，该文件可以在 Microsoft Visual C++ 中进行编辑。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 ProjWYF.pch 的预编译头(PCH)文件和名为 StdAfx.obj 的预编译类型文件。
